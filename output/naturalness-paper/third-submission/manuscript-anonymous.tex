...
As noted in \S\S \ref{s:analysis2} and \ref{s:analysis1}, \emph{be annoyed} and \emph{know} received relatively low mean naturalness ratings in the explicit ignorance context compared to the other clause-embedding predicates. In this section, we briefly consider factors that may have contributed to these relatively low ratings. 
